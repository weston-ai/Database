# SCRIPT OBJECTIVE: Conduct stratified sampling from a longitudinal diabetes dataset, clean the column headers, create sql scheme, upload the sql table scheme to a postgreSQL database, copy the sampled data to the SQL table, and run verification to evaluate the characteristics of the copied table.
...
# Treatment
# Drug A                   4000  / 20000 = 20%
# Drug A with Exercise     4000  / 20000 = 20%
# Placebo with Exercise    4000  / 20000 = 20%
...
# export PG_DBNAME="actual dbname"
# export PG_USER="actual username"
# export PG_PASSWORD="actual password"
# export PG_HOST="actual host"
# export PG_PORT="actual port"
...
# Read the .sql schema file (note this will not loop over multiple .sql schemas)
